 ...
 * @author ethan
 */
public class MillionaireApp extends javax.swing.JFrame {
    ...
    public void ActionListeners() {
        ...
        A.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                answers.insertDataIntoAATable(round, input);        //Inserts the "A" input and the current round number into the UsersAnswersDB_Ebd database when the user presses this A button
    ...
    public static void main(String args[]) throws SQLException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MillionaireApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Controls().setVisible(true);
                new MillionaireApp().setVisible(true);
            }
        });
    }
